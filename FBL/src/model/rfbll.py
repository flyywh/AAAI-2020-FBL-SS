...
class RDB(nn.Module):
    def __init__(self, growRate0, nConvLayers, kSize=3):
        ...
        self.conv5 = RDB_Conv(G0)
        self.conv6 = RDB_Conv(G0)
        self.conv7 = RDB_Conv(G0)
        self.conv8 = RDB_Conv(G0)
...
class RDB_L2(nn.Module):
    def __init__(self, growRate0, nConvLayers, kSize=3):
        ...
        self.conv3 = RDB(growRate0 = G0, nConvLayers = C)
        self.conv4 = RDB(growRate0 = G0, nConvLayers = C)
